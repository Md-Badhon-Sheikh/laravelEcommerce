...
Route::middleware(['auth', 'AuthAdmin'])->group(function () {
    Route::group(['prefix' => 'admin'], function () {
        ...
        Route::post('/products/store', [ProductController::class, 'store_product'])->name('store.product');
        Route::get('/products/edit/{id}', [ProductController::class, 'edit_product'])->name('edit.product');
        Route::post('/products/update/{id}', [ProductController::class, 'update_product'])->name('update.product');
    }); 
});